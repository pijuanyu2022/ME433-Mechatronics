...
int main() {
    ...
    //initialize MCP23017
    //TRISBbits.TRISB8 = 0; // connect SCK and B8
    //TRISBbits.TRISB9 = 0; // connect SDA and B9
    ...
    //i2c_init();
    while (1) {
        blink_LED(); // PIC is running when the LED is blinking
        //set_Pin(0x14, 0xFF);  // set OLATA = 0xFF to set A pins as high
    }
